...
(function($){
    ...
    $(function() {
        ...
        if( $(window).width() < 767) {
            if ($('#videoBG').length) {
                var videoG = document.getElementById('videoBG');
                videoG.play();    
            }
            if ($('#videoM').length) {
        ...
        // if( $(window).width() > 767) {
            ...
            setTimeout( function() {
            	$('#master .nav-desktop').addClass('visible');
            }, 700);

            setTimeout( function() {
            	$('#master .overlay').addClass('visible');
            }, 1800);

            setTimeout( function() {
            	$('#master video#videoBG').addClass('visible');
            }, 1900);

            setTimeout( function() {
            	$('#master .navbar-brand').addClass('visible');
            }, 2100);

            setTimeout( function() {
            	$('#master .content h1 span').first().addClass('visible');
            }, 2200);

            setTimeout( function() {
            	$('#master .content h1 span').last().addClass('visible');
            }, 2300);

            setTimeout( function() {
            	$('#master .content p.description').addClass('visible');
            }, 2400);

            setTimeout( function() {
            	$('#master .content button.connect-facebook').addClass('visible');
            }, 2500);

            setTimeout( function() {
            	$('#master .content button.signup').addClass('visible');
            }, 2600);

            setTimeout( function() {
                $('#master section.slider .grid-slider').addClass('visible');
            }, 2700);
